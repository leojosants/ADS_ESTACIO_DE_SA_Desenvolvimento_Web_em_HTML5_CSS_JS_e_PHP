        ...
        <form action="processa_anuncio.php" method="post">
            ...
            <div class="col-4">
                <div class="form-check form-check-inline">
                    ...
                    <input type="radio" class="form-check-input" name="sexo" id="sexoM" value="M" <?php echo $result["sexo"] == "M" ? "checked" : "disabled" ?> />
                </div>

                <div class="form-check form-check-inline">
                    <label for="sexoF" class="form-check-label">Fêmea</label>
                    <input type="radio" class="form-check-input" name="sexo" id="sexoF" value="F" <?php echo $result["sexo"] == "F" ? "checked" : "disabled" ?> />
                </div>
            </div>
